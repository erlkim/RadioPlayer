...
const RADIO_NAME = 'Kim Radio Online';

// Change Zeno Stream URL Here, .
const URL_STREAMING = 'https://stream.zeno.fm/dluqa91qwdruv';

//API URL Zeno Now Playing
const url = 'https://api.zeno.fm/mounts/metadata/subscribe/dluqa91qwdruv';
